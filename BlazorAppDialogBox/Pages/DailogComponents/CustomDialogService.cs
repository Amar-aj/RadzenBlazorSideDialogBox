...
namespace BlazorAppDialogBox.Pages.DailogComponents;
/// <summary>
...
/// </code>
/// </example>
public class CustomDialogService : IDisposable
{
    private DotNetObjectReference<CustomDialogService> reference;
    internal DotNetObjectReference<CustomDialogService> Reference
    {
        get
        {
            if (reference == null)
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CustomDialogService"/> class.
    /// </summary>
    /// <param name="uriHelper">The URI helper.</param>
    /// <param name="jsRuntime">IJSRuntime instance.</param>
    public CustomDialogService(NavigationManager uriHelper, IJSRuntime jsRuntime)
    {
        UriHelper = uriHelper;
        JSRuntime = jsRuntime;
    ...
    /// <summary>
    /// Occurs when the side dialog data is saved successfully.
    /// </summary>
    public event Action<bool> OnSideDialogSave;
    ...
    public void CloseSide(dynamic result = null)
    {
        ...
        // Trigger the OnSideDialogSave event if the result is true
        if (result == true)
        {
            OnSideDialogSave?.Invoke(true);
        }
    }
...
//    public RenderFragment<CustomDialogService> ChildContent { get; set; }
//    /// <summary>
//    /// Gets or sets the title content.
//    /// </summary>
//    /// <value>The title content.</value>
//    public RenderFragment<CustomDialogService> TitleContent { get; set; }
//    /// <summary>
//    /// Gets or sets a value indicating whether to focus the first focusable HTML element. Set to <c>true</c> by default.
//    /// </summary>
